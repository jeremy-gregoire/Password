...
#---------------------------------------------------------------PARAMETRE DE LA FENETRE, NE PAS TOUCHER
...
motdepasse.grid_rowconfigure((0,1,2,3,4,5,6,7),minsize=15, weight=5)
#fond de le fenetre
...
nomutilisateur.grid(row=2, columnspan=2, ipadx=75, ipady=5)
...
entry_mdp.grid(row=4, columnspan=2, ipadx=75, ipady=5)
#-frame 2 dans frame 1
toggle_btn=tkinter.Button(motdepasse, command=visibility, activebackground="#CDCDC1")
toggle_btn_frame=tkinter.Frame(entry_mdp_frame)
toggle_btn.grid(row=4, column=1)

#Widgets Button sup
#ajouter command = 
connexion_bouton = tkinter.Button(text = "Connexion", width=30, height=2, font=("Arial", 12), bg="#F5F5DC", activebackground="#CDCDC1")
connexion_bouton.grid(row=5, columnspan=2)
#ajouter command = 
generate_bouton = tkinter.Button(text = "Générer un mot de passe", width=30, height=2, font=("Arial", 12), bg="#FFF8DC", activebackground="#CDCDC1")
generate_bouton.grid(row=6, columnspan=2)
#ajouter command = 
save_bouton = tkinter.Button(text = "Enregistrer", width=30, height=2, font=("Arial", 12), bg="#EEE8CD", activebackground="#CDCDC1")
save_bouton.grid(row=7, columnspan=2)
#ajouter command = 
forgot_bouton = tkinter.Button(text = "Mot de passe oublié ?", width=30, height=2, font=("Arial", 12), bg="#CDC8B1", activebackground="#CDCDC1")
forgot_bouton.grid(row=8, columnspan=2,pady=6)
...
motdepasse.resizable(width=False, height=False) 
